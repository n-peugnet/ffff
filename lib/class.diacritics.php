...
class Diacritics
{
	...
	{
		$flags = "um";
		for ($i = 0; $i < sizeof(Diacritics::REMOVAL_MAP); $i++) {
			$str = preg_replace(Diacritics::REMOVAL_MAP[$i]['letters'] . $flags, Diacritics::REMOVAL_MAP[$i]['base'], $str);
		}
		return $str;
	}
}
